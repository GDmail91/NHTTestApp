...
/**
 * Created by 영수 on 2015-09-16.
 */
public class CounterSetting extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.counter_setting);
        ...
        counter_end_adapter = ArrayAdapter.createFromResource(this, R.array.counter_end_type, android.R.layout.simple_spinner_dropdown_item);
