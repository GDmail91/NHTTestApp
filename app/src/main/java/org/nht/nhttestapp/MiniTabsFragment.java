...
public class MiniTabsFragment extends Fragment {
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container, Bundle savedInstanceSate) {
        View view = inflater.inflate(R.layout.fragment_mini_tabs, container, false);
            ...
            switch (position) {
                case 0: // 첫번째 탭
                    ...
                    mButtonAction4.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(getActivity(), CheckerSetting.class);
                            startActivity(intent);
                        }
                    });
                    ...
                    mButtonAction5.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            Intent intent = new Intent(getActivity(), CounterSetting.class);
                            startActivity(intent);
                        }
                    });
